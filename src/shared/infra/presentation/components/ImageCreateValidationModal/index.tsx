...
export function ImageCreateValidationModal({
  ...
  return (
    <div
      className="p-1 bg-black fixed inset-0 z-50 flex items-center justify-center bg-opacity-40 backdrop-blur-sm"
    ...
    >
      ...
      >
        <div className="flex flex-col flex-wrap items-center justify-between gap-1.5">
          <h2 className="text-lg font-semibold text-gray-900-tk">
            ...
            <div className="flex w-full flex-wrap justify-between gap-1">
              {imageData.direitosImagem && (
                <div className="flex flex-col w-[250px] md:w-[300px]">
                  ...
                  <p className="text-md text-gray-900-tk">{imageData.direitosImagem}</p>
                </div>
              )}
              ...
              {imageData.tecidoOrgao && (
                <div className="flex flex-col w-[250px] md:w-[300px]">
                  ...
                  <p className="text-md text-gray-900-tk">{imageData.tecidoOrgao}</p>
                </div>
              )}
              ...
              {imageData.estadoPeca && (
                <div className="flex flex-col w-[250px] md:w-[300px]">
                  ...
                  <p className="text-md text-gray-900-tk">{imageData.estadoPeca}</p>
                </div>
              )}
              ...
              {imageData.dataCadastro && (
                <div className="flex flex-col w-[250px] md:w-[300px]">
                  ...
                  <p className="text-md text-gray-900-tk">{imageData.dataCadastro}</p>
                </div>
              )}
              ...
              {imageData.tituloImagem && (
                <div className="flex flex-col w-[250px] md:w-[300px]">
                  ...
                  <p className="text-md text-gray-900-tk">{imageData.tituloImagem}</p>
                </div>
              )}
              ...
              {imageData.descricaoImagem && (
                <div className="flex flex-col w-[250px] md:w-[300px]">
                  ...
                  <p className="text-md text-gray-900-tk">{imageData.descricaoImagem}</p>
                </div>
              )}
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-0.5 py-0.5">
                    {imageData.tags.map((tag, index) => (
                      <span
                        key={index}
                        className="rounded-md bg-gray-900-tk px-0.5 py-0.25 text-md text-gray-100-tk"
                      >
                        {tag}
                      </span>
                    ))}
          ...
          <div className="flex w-full items-center justify-between gap-1 md:flex-row [&>button]:rounded-lg [&>button]:px-2 [&>button]:py-1 [&>button]:text-gray-100-tk text-md">
            <button 
              onClick={onClose}
              className="bg-fail"
            >
